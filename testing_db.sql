...
--
-- Хост: localhost
-- Время создания: Фев 03 2014 г., 23:42
...
(49, 5, 1, 'совокупность взаимосвязанных данных, организованных по определенным правилам, предусматривающим общие принципы описания, хранения и обработки данных;', 1, '0'),
(49, 10, 1, 'бд, в которой существует возможность устанавливать дополнительно к вертикальным иерархическим связям горизонтальные связи.', 0, '0'),
(49, 11, 5, 'строка', 0, '0'),
(49, 12, 5, 'столбец таблицы', 1, '0'),
(50, 5, 1, 'совокупность взаимосвязанных данных, организованных по определенным правилам, предусматривающим общие принципы описания, хранения и обработки данных;', 1, '0'),
(50, 10, 1, 'бд, в которой элементы в записи упорядочены, т.е. один элемент считается главным, остальные подчиненными;', 1, '0'),
(50, 11, 5, 'строка', 0, '0'),
(50, 12, 5, 'столбец таблицы', 1, '0');
...
(17, 'ОБД', NULL, '{"min_ip":"127.0.0.1","max_ip":"127.255.255.255","min":"2","max":"4","algo":"middle"}', 2, 1, 2, 4, 1, '{"1":"1","5":"5"}', 1);
